...
export const madrasaHero: HeroContent = {
  ...
  badge: "Evening Madrasa — 3:00pm to 5:00pm",
};
...
export const madrasaTimetable = [
  { time: "3:00pm – 3:15pm", activity: "Arrival, Wudu & Opening Dua" },
  { time: "3:15pm – 5:00pm", activity: "Quran Recitation / Hifz Session" },
  { time: "5:00pm – 5:30pm", activity: "Arabic Language" },
  { time: "5:30pm – 5:35pm", activity: "Maghrib Salah & Break" },
  { time: "5:35pm – 6:30pm", activity: "Islamic Studies (Aqeedah / Fiqh / Seerah)" },
  { time: "6:30pm – 5:00pm", activity: "Revision, Duas & Dismissal" },
];
