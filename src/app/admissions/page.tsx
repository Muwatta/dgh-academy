...
import {
  admissionRequirements, entryClasses, schoolInfo
} from "@/data/school";

export const metadata: Metadata = {
  title: "Admissions",
  description: "Apply for admission to Dr. Gambo Hamza Islamic Academy. Open to Toddler through Basic 4. Contact us on 08168369019.",
};
      ...
      <main>
        <section className="school-gradient pattern-islamic py-20">
          <div className="container">
            <div className="section-tag bg-[var(--school-accent)]/15 text-[var(--school-accent)]">Join Us</div>
            <h1 className="font-amiri text-5xl font-bold text-white mt-2 mb-4">Admissions</h1>
            <p className="text-[var(--school-cream)]/70 max-w-xl">
              We welcome applications for all classes from Toddler to Basic 4. Follow the steps below to secure your child's place.
            </p>
          </div>
        </section>
              ...
              <div>
                ...
                <div className="bg-[var(--school-cream)] rounded-xl p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {entryClasses.map((c) => (
                      <span key={c} className="text-sm px-4 py-1.5 bg-white text-[var(--school-primary)] rounded-full font-semibold border border-[var(--school-cream-dark)] shadow-sm">{c}</span>
                    ))}
                  </div>
                </div>

                <div className="mt-6 p-4 bg-[var(--school-primary)] rounded-xl text-[var(--school-cream)]">
                  <div className="font-bold mb-1">Questions? Contact the School Administrator</div>
                  <div className="text-sm opacity-80">📞 {schoolInfo.phone}</div>
                  <div className="text-sm opacity-80">✉️ {schoolInfo.email}</div>
                </div>
              </div>
                ...
                <form className="space-y-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input type="email" className="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:border-[var(--school-primary)] transition-colors" />
                    </div>
                  </div>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <input type="date" required className="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:border-[var(--school-primary)] transition-colors" />
                    </div>
                  </div>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-xs font-bold text-[var(--school-text-muted)] uppercase tracking-wider block mb-1.5">Gender *</label>
                      <select required className="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:border-[var(--school-primary)] bg-white transition-colors">
                    ...
                    <div>
                      ...
                      <select required className="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:border-[var(--school-primary)] bg-white transition-colors">
                        ...
                        {entryClasses.map((c) => <option key={c}>{c}</option>)}
                      </select>
                    </div>
                  </div>
                  <div>
                    ...
                    <input type="text" className="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:border-[var(--school-primary)] transition-colors" />
                  </div>
                  <div>
                    ...
                    <textarea rows={3} className="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:border-[var(--school-primary)] resize-none transition-colors" />
                  </div>
                  ...
                  <p className="text-xs text-center text-[var(--school-text-muted)]">
                    We will contact you within 24–48 hours to confirm your application.
                  </p>
                </form>
              </div>
            </div>
